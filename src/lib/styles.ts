...
export const CHIP_BASE = "rounded-lg border px-2.5 py-1.5 text-xs font-medium transition-all";
export const CHIP_ACTIVE = "border-primary/40 bg-primary/15 text-primary";
