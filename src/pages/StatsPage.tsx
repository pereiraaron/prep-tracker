...
const DIFF_COLORS = ["hsl(155, 65%, 42%)", "hsl(42, 95%, 52%)", "hsl(0, 72%, 55%)"];
    ...
    <Layout>
      ...
      {overviewLoading ? (
        ...
        <>
          ...
          {streaks && (
            <div className="mb-8 grid grid-cols-3 gap-3">
              <div className="glass-card rounded-xl p-4 text-center">
                <div className="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-lg bg-stat-orange/10">
                  <Flame className="h-5 w-5 text-stat-orange" />
                </div>
                <p className="font-display text-2xl font-bold">{streaks.currentStreak}</p>
                <p className="text-xs text-muted-foreground">Current Streak</p>
              </div>
              <div className="glass-card rounded-xl p-4 text-center">
                <div className="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-lg bg-stat-purple/10">
                  <Zap className="h-5 w-5 text-stat-purple" />
                </div>
                <p className="font-display text-2xl font-bold">{streaks.longestStreak}</p>
                <p className="text-xs text-muted-foreground">Best Streak</p>
              </div>
              <div className="glass-card rounded-xl p-4 text-center">
                <div className="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-lg bg-stat-blue/10">
                  <Calendar className="h-5 w-5 text-stat-blue" />
                </div>
                <p className="font-display text-2xl font-bold">{streaks.totalActiveDays}</p>
          ...
          {/* ── Insights ── */}
          {insights && (insights.weakAreas.length > 0 || insights.milestones.length > 0) && (
            <>
